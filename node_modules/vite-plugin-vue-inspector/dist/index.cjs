...
async function compileSFCTemplate({ code, id, type }) {
  ...
  const relativePath = (0, import_vite.normalizePath)(import_path.default.relative(process.cwd(), id));
...
function getInspectorPath() {
  const pluginPath = (0, import_vite2.normalizePath)(import_path2.default.dirname((0, import_url.fileURLToPath)(importMetaUrl)));
